<%-- 
    Document   : verPublicacionAncladaAdministrador
    Created on : 1 dic. 2024, 17:26:13
    Author     : Jose Pablo
--%>
        ...
        <div class="container">
            ...
            <header class="barra-navegacion">
                <div class="custom-logo2">
                    <a href="VolverPublicacionesAdministrador"><img src="imgs/logo-dinosaurio.png" alt="Logo personalizado"></a>
                </div>
