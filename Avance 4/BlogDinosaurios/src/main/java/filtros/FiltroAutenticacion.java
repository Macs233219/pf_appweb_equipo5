...
public class FiltroAutenticacion implements Filter {
    ...
    private static final String[] urlPublicas = {
        ...
        "registrarse.jsp",
        "verPublicacion.jsp",
        "verPublicaciones.jsp",
        "verPublicacionAnclada.jsp",
        "FormularioRegistro",
        "IniciarSesion",
        "Registrarse",
        "VerPublicacion",
        "VerPublicacionAnclada",
        "VolverPublicacion",
        "error.css",
        "iniciarSesion.css",
        "publicacion.css",
        ...
        "crearPublicacionScript.js",
        "crearComentarioScript.js"
    };
    ...
    // verifica si la ruta en la que se requiere acceder es privada
    private boolean esURLPrivada(String ruta) {
        ...
        if (ruta.startsWith("/styles/") || ruta.startsWith("/js/") || ruta.startsWith("/imgs/")) {
            return false;
        }
